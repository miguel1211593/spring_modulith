 ...
 */
@Controller
public class MonoVisitController {

	private final MonoOwnerRepository owners;

	public MonoVisitController(MonoOwnerRepository owners) {
		this.owners = owners;
	}
	...
	public MonoVisit loadPetWithVisit(@PathVariable("ownerId") int ownerId, @PathVariable("petId") int petId,
	...
	public String processNewVisitForm(@ModelAttribute MonoOwner owner, @PathVariable int petId, @Valid MonoVisit visit,
