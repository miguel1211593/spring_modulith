...
ALTER TABLE owner_pets ADD CONSTRAINT fk_owner_pets_types FOREIGN KEY (type_id) REFERENCES types (id);
...
ALTER TABLE owner_visits ADD CONSTRAINT fk_owner_visits_pets FOREIGN KEY (pet_id) REFERENCES pets (id);
